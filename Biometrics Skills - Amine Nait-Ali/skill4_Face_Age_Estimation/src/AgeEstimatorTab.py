...
class AgeEstimator:
    """Handles age estimation logic for different models"""
    def __init__(self):
    ...
    def process_frame(self, frame):
        ...
        for (x, y, w, h) in faces:
            ...
            pred_age = round(predictions[1][0][0])  # Using only age prediction
            ...
            # Add text
            cv2.putText(frame, f"Age: {pred_age}", (x + 6, y + h + 20), 
...
class AgeEstimationImageTab(QWidget):
    """Tab for uploading and processing images for age estimation"""
    ...
    def init_ui(self):
        ...
        self.model_selector.addItems(["ResNet50", "Custom CNN"])
        ...
        self.estimate_button = QPushButton("Estimate Age")
...
class AgeEstimationWebcamTab(QWidget):
    """Tab for real-time webcam age estimation"""
    def __init__(self, estimator):
        super().__init__()
        self.estimator = estimator
        self.init_ui()
...
class AgeEstimationTab(QWidget):
    """Age Estimation Tab with sub-tabs"""
    def __init__(self):
        super().__init__()
        self.estimator = AgeEstimator()
        self.init_ui()
    ...
    def init_ui(self):
        ...
        self.sub_tabs.addTab(AgeEstimationImageTab(self.estimator), "Upload")
        self.sub_tabs.addTab(AgeEstimationWebcamTab(self.estimator), "Webcam")
