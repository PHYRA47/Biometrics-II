...
class EmotionRecognitionImageTab(QWidget):
...
class EmotionRecognitionWebcamTab(QWidget):
...
class EmotionRecognitionTab(QWidget):
    ...
    def init_ui(self):
        ...
        self.sub_tabs.addTab(EmotionRecognitionImageTab(self.recognizer), "Upload")
        self.sub_tabs.addTab(EmotionRecognitionWebcamTab(self.recognizer), "Webcam")
